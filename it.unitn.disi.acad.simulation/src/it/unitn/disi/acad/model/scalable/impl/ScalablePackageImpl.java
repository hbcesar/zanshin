...
public class ScalablePackageImpl extends EPackageImpl implements ScalablePackage {
	 ...
	 * @see it.unitn.disi.acad.model.scalable.ScalablePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>This method is used to initialize {@link ScalablePackage#eINSTANCE} when that field is accessed.
	...
	public static ScalablePackage init() {
		if (isInited) return (ScalablePackage)EPackage.Registry.INSTANCE.getEPackage(ScalablePackage.eNS_URI);
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("it.unitn.disi.acad.model.scalable." + eClassifier.getName()); //$NON-NLS-1$
