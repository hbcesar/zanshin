 ...
 * $Id$
 */
package it.unitn.disi.acad.model.acad.impl;
...
public class AcadPackageImpl extends EPackageImpl implements AcadPackage {
	 ...
	 * @see it.unitn.disi.acad.model.acad.AcadPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(ar1EClass, it.unitn.disi.acad.model.acad.AR1.class, "AR1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar2EClass, it.unitn.disi.acad.model.acad.AR2.class, "AR2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar3EClass, it.unitn.disi.acad.model.acad.AR3.class, "AR3", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar4EClass, it.unitn.disi.acad.model.acad.AR4.class, "AR4", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar5EClass, it.unitn.disi.acad.model.acad.AR5.class, "AR5", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar6EClass, it.unitn.disi.acad.model.acad.AR6.class, "AR6", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar7EClass, it.unitn.disi.acad.model.acad.AR7.class, "AR7", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar8EClass, it.unitn.disi.acad.model.acad.AR8.class, "AR8", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar9EClass, it.unitn.disi.acad.model.acad.AR9.class, "AR9", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar10EClass, it.unitn.disi.acad.model.acad.AR10.class, "AR10", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar11EClass, it.unitn.disi.acad.model.acad.AR11.class, "AR11", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar12EClass, it.unitn.disi.acad.model.acad.AR12.class, "AR12", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar13EClass, it.unitn.disi.acad.model.acad.AR13.class, "AR13", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar14EClass, it.unitn.disi.acad.model.acad.AR14.class, "AR14", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$

		initEClass(ar15EClass, it.unitn.disi.acad.model.acad.AR15.class, "AR15", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
