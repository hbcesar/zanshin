...
public interface EcaAwReq extends AwReq {
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.eca.EcaAwReq#getCondition <em>Condition</em>}'
	 ...
	 * {@link it.unitn.disi.zanshin.model.eca.AdaptationStrategy}. It is bidirectional and its opposite is '
	...
	/**
	 * Returns the value of the '<em><b>Selected Strategy</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.eca.EcaAwReq#getSelectedStrategy
	 * <em>Selected Strategy</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Selected Strategy</em>' reference.
