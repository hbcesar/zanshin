...
public interface Event extends EObject {
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.eca.Event#getSession <em>Session</em>}' container
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Session</em>' container reference.
	 * @see #getSession()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Aw Req</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Aw Req</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Aw Req</em>' reference.
	 * @see #getAwReq()
	 * @generated
	 */
