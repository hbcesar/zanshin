 ...
 * <ul>
 * <li>{@link it.unitn.disi.zanshin.model.eca.ReconfigurationApplicabilityCondition#getWrappedCondition <em>Wrapped
 * Condition</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface ReconfigurationApplicabilityCondition extends ApplicabilityCondition {
	 ...
	 * <p>
	 * If the meaning of the '<em>Wrapped Condition</em>' containment reference isn't clear, there really should be more
	 ...
	 * <em>Wrapped Condition</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Wrapped Condition</em>' containment reference.
