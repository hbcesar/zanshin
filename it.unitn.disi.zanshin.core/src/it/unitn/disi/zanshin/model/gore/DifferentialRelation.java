...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Differential Relation</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface DifferentialRelation extends EObject {
	/**
	 * Returns the value of the '<em><b>Indicator</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Indicator</em>' reference isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.gore.DifferentialRelation#getIndicator
	 * <em>Indicator</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Indicator</em>' reference.
	 * @see #getIndicator()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.gore.DifferentialRelation#getParameter
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.gore.DifferentialRelation#getLowerBound
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.gore.DifferentialRelation#getUpperBound
	...
	/**
	 * Returns the value of the '<em><b>Operator</b></em>' attribute. The literals are from the enumeration
	 * {@link it.unitn.disi.zanshin.model.gore.DifferentialRelationOperator}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.gore.DifferentialRelation#getOperator <em>Operator</em>}'
	...
	/**
	 * Returns the value of the '<em><b>Value</b></em>' attribute. The default value is <code>"0.0"</code>. <!--
	 * begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link it.unitn.disi.zanshin.model.gore.DifferentialRelation#getValue <em>Value</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
