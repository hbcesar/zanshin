...
public interface Parameter extends EObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='org.eclipse.emf.ecore.util.EcoreUtil.Copier copier = new org.eclipse.emf.ecore.util.EcoreUtil.Copier();\nParameter copy = (Parameter) copier.copy(this);\nreturn copy;'"
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="http://www.eclipse.org/emf/2002/GenModel body='// Obtains the operator from the differential relation to check the increment direction.\nString newValue = null;\nswitch (relation.getOperator()) {\ncase FEWER_THAN:\n\tnewValue = subtractedFrom(value);\n\tbreak;\ncase GREATER_THAN:\n\tnewValue = addedTo(value);\n\tbreak;\n}\n\n// Changes the parameter\'s value to the new value.\nif (newValue != null)\n\tsetValue(newValue);'"
	 * @generated
	 */
