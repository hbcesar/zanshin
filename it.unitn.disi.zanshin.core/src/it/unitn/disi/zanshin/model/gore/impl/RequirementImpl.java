...
public class RequirementImpl extends OclAnyImpl implements Requirement {
	...
	public void replaceWith(Requirement newRequirement) {
		...
		it.unitn.disi.zanshin.core.CoreUtils.log.debug("Requirement requirement instances of class {0} ({1} -> {2})", eClass().getName(), this, newRequirement); //$NON-NLS-1$
