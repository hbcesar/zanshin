...
public interface GoalModel extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link it.unitn.disi.zanshin.model.gore.Goal#getGoalModel <em>Goal Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * The list contents are of type {@link it.unitn.disi.zanshin.model.gore.Softgoal}.
	 * It is bidirectional and its opposite is '{@link it.unitn.disi.zanshin.model.gore.Softgoal#getGoalModel <em>Goal Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Aw Reqs</b></em>' containment reference list.
	 * The list contents are of type {@link it.unitn.disi.zanshin.model.gore.AwReq}.
	 * It is bidirectional and its opposite is '{@link it.unitn.disi.zanshin.model.gore.AwReq#getGoalModel <em>Goal Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Aw Reqs</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link it.unitn.disi.zanshin.model.gore.Parameter#getGoalModel <em>Goal Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
