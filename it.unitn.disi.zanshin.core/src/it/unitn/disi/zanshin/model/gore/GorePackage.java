...
public interface GorePackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Softgoals</b></em>' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Aw Reqs</b></em>' containment reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the '{@link it.unitn.disi.zanshin.model.gore.impl.ReconfigurationAlgorithmImpl
	 * <em>Reconfiguration Algorithm</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The number of structural features of the '<em>Reconfiguration Algorithm</em>' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * Returns the meta object for the container reference '{@link it.unitn.disi.zanshin.model.gore.Softgoal#getGoalModel
	 ...
	 * {@link it.unitn.disi.zanshin.model.gore.QualityConstraint#getSoftgoal <em>Softgoal</em>}'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the container reference '{@link it.unitn.disi.zanshin.model.gore.AwReq#getGoalModel
	 * <em>Goal Model</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the container reference '<em>Goal Model</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list '
	 * {@link it.unitn.disi.zanshin.model.gore.GoalModel#getSoftgoals <em>Softgoals</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the containment reference list '
	 * {@link it.unitn.disi.zanshin.model.gore.GoalModel#getAwReqs <em>Aw Reqs</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for class '{@link it.unitn.disi.zanshin.model.gore.ReconfigurationAlgorithm
	 * <em>Reconfiguration Algorithm</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Softgoal</b></em>' container reference feature. <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Aw Reqs</b></em>' containment reference list feature. <!-- begin-user-doc
		 * --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '{@link it.unitn.disi.zanshin.model.gore.impl.ReconfigurationAlgorithmImpl
		 * <em>Reconfiguration Algorithm</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see it.unitn.disi.zanshin.model.gore.impl.ReconfigurationAlgorithmImpl
		 * @see it.unitn.disi.zanshin.model.gore.impl.GorePackageImpl#getReconfigurationAlgorithm()
