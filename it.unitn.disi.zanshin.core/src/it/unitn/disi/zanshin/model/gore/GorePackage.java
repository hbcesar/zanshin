...
public interface GorePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int GOAL_ORIENTED_REQUIREMENT__PARENT = GORE_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int GOAL_ORIENTED_REQUIREMENT__CHILDREN = GORE_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int GOAL_ORIENTED_REQUIREMENT__ASSUMPTIONS = GORE_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int PERFORMATIVE_REQUIREMENT__CHILDREN = GOAL_ORIENTED_REQUIREMENT__CHILDREN;
	 ...
	 * @ordered
	 */
	int HARD_GOAL__CHILDREN = PERFORMATIVE_REQUIREMENT__CHILDREN;
	 ...
	 * @ordered
	 */
	int HARD_GOAL__TASKS = PERFORMATIVE_REQUIREMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SOFTGOAL__CHILDREN = GOAL_ORIENTED_REQUIREMENT__CHILDREN;
	 ...
	 * @ordered
	 */
	int DOMAIN_ASSUMPTION_FEATURE_COUNT = GORE_ELEMENT_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link it.unitn.disi.zanshin.model.gore.GoalOrientedRequirement#getChildren <em>Children</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getGoalOrientedRequirement_Children();
	...
	/**
	 * Returns the meta object for the reference list '{@link it.unitn.disi.zanshin.model.gore.Softgoal#getConstraints <em>Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link it.unitn.disi.zanshin.model.gore.QualityConstraint#getSoftgoal <em>Softgoal</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference GOAL_ORIENTED_REQUIREMENT__CHILDREN = eINSTANCE.getGoalOrientedRequirement_Children();
