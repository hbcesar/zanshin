...
public enum AggregationLevel implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>Aggregation Level</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	private static final AggregationLevel[] VALUES_ARRAY = new AggregationLevel[] { INSTANCE, CLASS, BOTH, };

	/**
	 * A public read-only list of all the '<em><b>Aggregation Level</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Aggregation Level</b></em>' literal with the specified literal value. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Aggregation Level</b></em>' literal with the specified name. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Aggregation Level</b></em>' literal with the specified integer value. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
