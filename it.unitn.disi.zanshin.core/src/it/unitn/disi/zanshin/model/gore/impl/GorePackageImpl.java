...
public class GorePackageImpl extends EPackageImpl implements GorePackage {
	...
	public void initializePackageContents() {
		...
		op = addEOperation(softgoalEClass, null, "replaceWith", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getRequirement(), "newRequirement", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(awReqEClass, null, "replaceWith", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getRequirement(), "newRequirement", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
