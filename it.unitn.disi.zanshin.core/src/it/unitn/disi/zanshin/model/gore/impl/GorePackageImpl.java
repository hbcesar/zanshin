...
public class GorePackageImpl extends EPackageImpl implements GorePackage {
	...
	public EAttribute getAwReq_IncrementCoefficient() {
		return (EAttribute)awReqEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getGoalModel_InternalId() {
		return (EAttribute)goalModelEClass.getEStructuralFeatures().get(4);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRequirement_RefinementType(), this.getRefinementType(), "refinementType", null, 0, 1, Requirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(requirementEClass, this.getGoalModel(), "findGoalModel", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(requirementEClass, ecorePackage.getEInt(), "getChildrenStateCount", 0, -1, IS_UNIQUE, IS_ORDERED);

		EOperation op = addEOperation(requirementEClass, null, "replaceWith", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getRequirement(), "newRequirement", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(definableRequirementEClass, DefinableRequirement.class, "DefinableRequirement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDefinableRequirement_Time(), ecorePackage.getEDate(), "time", null, 0, 1, DefinableRequirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDefinableRequirement_State(), this.getDefinableRequirementState(), "state", "", 0, 1, DefinableRequirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(definableRequirementEClass, null, "start", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(definableRequirementEClass, null, "end", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(definableRequirementEClass, null, "success", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(definableRequirementEClass, null, "fail", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(definableRequirementEClass, null, "checkState", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getSoftgoal_GoalModel(), this.getGoalModel(), this.getGoalModel_Softgoals(), "goalModel", null, 0, 1, Softgoal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = addEOperation(softgoalEClass, null, "replaceWith", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getRequirement(), "newRequirement", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getAwReq_OtherTargets(), this.getDefinableRequirement(), null, "otherTargets", null, 0, -1, AwReq.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAwReq_Target(), this.getDefinableRequirement(), null, "target", null, 1, 1, AwReq.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAwReq_GoalModel(), this.getGoalModel(), this.getGoalModel_AwReqs(), "goalModel", null, 0, 1, AwReq.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = addEOperation(awReqEClass, null, "replaceWith", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getRequirement(), "newRequirement", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getGoal_GoalModel(), this.getGoalModel(), this.getGoalModel_RootGoal(), "goalModel", null, 0, 1, Goal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGoalModel_RootGoal(), this.getGoal(), this.getGoal_GoalModel(), "rootGoal", null, 1, 1, GoalModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGoalModel_Softgoals(), this.getSoftgoal(), this.getSoftgoal_GoalModel(), "softgoals", null, 0, -1, GoalModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGoalModel_AwReqs(), this.getAwReq(), this.getAwReq_GoalModel(), "awReqs", null, 0, -1, GoalModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(definableRequirementStateEEnum, DefinableRequirementState.class, "DefinableRequirementState");
