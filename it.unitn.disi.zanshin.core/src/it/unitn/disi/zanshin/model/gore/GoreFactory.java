...
public interface GoreFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Definable Requirement</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return a new object of class '<em>Definable Requirement</em>'.
	 * @generated
	 */
	DefinableRequirement createDefinableRequirement();

	/**
	 * Returns a new object of class '<em>Softgoal</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Performative Requirement</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Quality Constraint</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Domain Assumption</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Reconfiguration Algorithm</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return a new object of class '<em>Reconfiguration Algorithm</em>'.
	 * @generated
	 */
	ReconfigurationAlgorithm createReconfigurationAlgorithm();
