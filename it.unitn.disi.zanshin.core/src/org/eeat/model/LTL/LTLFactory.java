...
public interface LTLFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Ocl Any</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Ocl Message</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Timeout</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Property Event</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
