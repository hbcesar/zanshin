...
import it.unitn.disi.zanshin.model.gore.provider.SoftgoalItemProvider;
...
/**
 * This is the item provider adapter for a {@link it.unitn.disi.acad.model.acad.S_UserFriendly} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class S_UserFriendlyItemProvider
	extends SoftgoalItemProvider
	implements
	 ...
	 * @generated
	 */
	public S_UserFriendlyItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns S_UserFriendly.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/S_UserFriendly"));
	}
	...
	public String getText(Object object) {
		RefinementType labelValue = ((S_UserFriendly)object).getRefinementType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_S_UserFriendly_type") :
			getString("_UI_S_UserFriendly_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GorePackage.Literals.SOFTGOAL__CONSTRAINTS,
				 AcadFactory.eINSTANCE.createQ_Dispatch()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			childFeature == GorePackage.Literals.REQUIREMENT__CHILDREN ||
			childFeature == GorePackage.Literals.SOFTGOAL__CONSTRAINTS;
