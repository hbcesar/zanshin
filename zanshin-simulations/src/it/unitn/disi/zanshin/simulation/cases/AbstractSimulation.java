...
public abstract class AbstractSimulation implements Simulation {
	...
	protected ZanshinRemote zanshin;

	/** @see it.unitn.disi.zanshin.simulation.cases.Simulation#init(java.lang.String, it.unitn.disi.zanshin.remote.ZanshinRemote) */
	@Override
	public final void init(String name, ZanshinRemote zanshin) throws Exception {
		this.name = name;
		this.zanshin = zanshin;
		doInit();
	}
