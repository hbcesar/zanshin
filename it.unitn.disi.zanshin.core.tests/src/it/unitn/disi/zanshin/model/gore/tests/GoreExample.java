...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>gore</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GoreExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.gore")); //$NON-NLS-1$
				Requirement root = GoreFactory.eINSTANCE.createRequirement();
