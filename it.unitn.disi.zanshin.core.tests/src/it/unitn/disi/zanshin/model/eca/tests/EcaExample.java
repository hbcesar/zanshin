...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>eca</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EcaExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.eca")); //$NON-NLS-1$
				EcaAwReq root = EcaFactory.eINSTANCE.createEcaAwReq();
