...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>LTL</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class LTLExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ltl")); //$NON-NLS-1$
				OclAny root = LTLFactory.eINSTANCE.createOclAny();
