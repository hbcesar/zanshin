 ...
 * @version 1.0
 */
public abstract class AbstractParameterChangeProcedure extends AbstractProcedure implements ParameterChangeProcedure {
	...
	public void replaceDefaultProcedure(AdaptationAlgorithm adaptationAlgorithm) {
		adaptationAlgorithm.setParameterChangeProcedure(this);
	}
}
