...
public class AcadSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case AcadPackage.GGEN_DISPATCH: {
			...
			if (result == null)
				result = caseGoal(g_GenDispatch);
			if (result == null)
				result = casePerformativeRequirement(g_GenDispatch);
			if (result == null)
				result = caseDefinableRequirement(g_GenDispatch);
			if (result == null)
				result = caseRequirement(g_GenDispatch);
			if (result == null)
				result = caseOclAny(g_GenDispatch);
			if (result == null)
		...
		case AcadPackage.GCALL_TAKING: {
			...
			if (result == null)
				result = caseGoal(g_CallTaking);
			if (result == null)
				result = casePerformativeRequirement(g_CallTaking);
			if (result == null)
				result = caseDefinableRequirement(g_CallTaking);
			if (result == null)
				result = caseRequirement(g_CallTaking);
			if (result == null)
				result = caseOclAny(g_CallTaking);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.DDATA_UPD: {
			...
			if (result == null)
				result = caseDomainAssumption(d_DataUpd);
			if (result == null)
				result = caseDefinableRequirement(d_DataUpd);
			if (result == null)
				result = caseRequirement(d_DataUpd);
			if (result == null)
				result = caseOclAny(d_DataUpd);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GRESOURCE_ID: {
			...
			if (result == null)
				result = caseGoal(g_ResourceId);
			if (result == null)
				result = casePerformativeRequirement(g_ResourceId);
			if (result == null)
				result = caseDefinableRequirement(g_ResourceId);
			if (result == null)
				result = caseRequirement(g_ResourceId);
			if (result == null)
				result = caseOclAny(g_ResourceId);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GRESOURCE_MOB: {
			...
			if (result == null)
				result = caseGoal(g_ResourceMob);
			if (result == null)
				result = casePerformativeRequirement(g_ResourceMob);
			if (result == null)
				result = caseDefinableRequirement(g_ResourceMob);
			if (result == null)
				result = caseRequirement(g_ResourceMob);
			if (result == null)
				result = caseOclAny(g_ResourceMob);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GOBTAIN_MAP: {
			...
			if (result == null)
				result = caseGoal(g_ObtainMap);
			if (result == null)
				result = casePerformativeRequirement(g_ObtainMap);
			if (result == null)
				result = caseDefinableRequirement(g_ObtainMap);
			if (result == null)
				result = caseRequirement(g_ObtainMap);
			if (result == null)
				result = caseOclAny(g_ObtainMap);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GINCIDENT_UPD: {
			...
			if (result == null)
				result = caseGoal(g_IncidentUpd);
			if (result == null)
				result = casePerformativeRequirement(g_IncidentUpd);
			if (result == null)
				result = caseDefinableRequirement(g_IncidentUpd);
			if (result == null)
				result = caseRequirement(g_IncidentUpd);
			if (result == null)
				result = caseOclAny(g_IncidentUpd);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.DMAX_CALLS: {
			...
			if (result == null)
				result = caseDomainAssumption(d_MaxCalls);
			if (result == null)
				result = caseDefinableRequirement(d_MaxCalls);
			if (result == null)
				result = caseRequirement(d_MaxCalls);
			if (result == null)
				result = caseOclAny(d_MaxCalls);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GREG_CALL: {
			...
			if (result == null)
				result = caseGoal(g_RegCall);
			if (result == null)
				result = casePerformativeRequirement(g_RegCall);
			if (result == null)
				result = caseDefinableRequirement(g_RegCall);
			if (result == null)
				result = caseRequirement(g_RegCall);
			if (result == null)
				result = caseOclAny(g_RegCall);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TCONFIRM_CALL: {
			...
			if (result == null)
				result = caseTask(t_ConfirmCall);
			if (result == null)
				result = casePerformativeRequirement(t_ConfirmCall);
			if (result == null)
				result = caseDefinableRequirement(t_ConfirmCall);
			if (result == null)
				result = caseRequirement(t_ConfirmCall);
			if (result == null)
				result = caseOclAny(t_ConfirmCall);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GASSIGN_INCIDENT: {
			...
			if (result == null)
				result = caseGoal(g_AssignIncident);
			if (result == null)
				result = casePerformativeRequirement(g_AssignIncident);
			if (result == null)
				result = caseDefinableRequirement(g_AssignIncident);
			if (result == null)
				result = caseRequirement(g_AssignIncident);
			if (result == null)
				result = caseOclAny(g_AssignIncident);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TSEARCH_DUPLIC: {
			...
			if (result == null)
				result = caseTask(t_SearchDuplic);
			if (result == null)
				result = casePerformativeRequirement(t_SearchDuplic);
			if (result == null)
				result = caseDefinableRequirement(t_SearchDuplic);
			if (result == null)
				result = caseRequirement(t_SearchDuplic);
			if (result == null)
				result = caseOclAny(t_SearchDuplic);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TCREATE_OR_ASSIGN: {
			...
			if (result == null)
				result = caseTask(t_CreateOrAssign);
			if (result == null)
				result = casePerformativeRequirement(t_CreateOrAssign);
			if (result == null)
				result = caseDefinableRequirement(t_CreateOrAssign);
			if (result == null)
				result = caseRequirement(t_CreateOrAssign);
			if (result == null)
				result = caseOclAny(t_CreateOrAssign);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TINPUT_INFO: {
			...
			if (result == null)
				result = caseTask(t_InputInfo);
			if (result == null)
				result = casePerformativeRequirement(t_InputInfo);
			if (result == null)
				result = caseDefinableRequirement(t_InputInfo);
			if (result == null)
				result = caseRequirement(t_InputInfo);
			if (result == null)
				result = caseOclAny(t_InputInfo);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TDETECT_LOC: {
			...
			if (result == null)
				result = caseTask(t_DetectLoc);
			if (result == null)
				result = casePerformativeRequirement(t_DetectLoc);
			if (result == null)
				result = caseDefinableRequirement(t_DetectLoc);
			if (result == null)
				result = caseRequirement(t_DetectLoc);
			if (result == null)
				result = caseOclAny(t_DetectLoc);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TSPEC_CONFIG: {
			...
			if (result == null)
				result = caseTask(t_SpecConfig);
			if (result == null)
				result = casePerformativeRequirement(t_SpecConfig);
			if (result == null)
				result = caseDefinableRequirement(t_SpecConfig);
			if (result == null)
				result = caseRequirement(t_SpecConfig);
			if (result == null)
				result = caseOclAny(t_SpecConfig);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TCONF_INCIDENT: {
			...
			if (result == null)
				result = caseTask(t_ConfIncident);
			if (result == null)
				result = casePerformativeRequirement(t_ConfIncident);
			if (result == null)
				result = caseDefinableRequirement(t_ConfIncident);
			if (result == null)
				result = caseRequirement(t_ConfIncident);
			if (result == null)
				result = caseOclAny(t_ConfIncident);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TDET_BEST_AMB: {
			...
			if (result == null)
				result = caseTask(t_DetBestAmb);
			if (result == null)
				result = casePerformativeRequirement(t_DetBestAmb);
			if (result == null)
				result = caseDefinableRequirement(t_DetBestAmb);
			if (result == null)
				result = caseRequirement(t_DetBestAmb);
			if (result == null)
				result = caseOclAny(t_DetBestAmb);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TINFORM_STAT: {
			...
			if (result == null)
				result = caseTask(t_InformStat);
			if (result == null)
				result = casePerformativeRequirement(t_InformStat);
			if (result == null)
				result = caseDefinableRequirement(t_InformStat);
			if (result == null)
				result = caseRequirement(t_InformStat);
			if (result == null)
				result = caseOclAny(t_InformStat);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GROUTE_ASSIST: {
			...
			if (result == null)
				result = caseGoal(g_RouteAssist);
			if (result == null)
				result = casePerformativeRequirement(g_RouteAssist);
			if (result == null)
				result = caseDefinableRequirement(g_RouteAssist);
			if (result == null)
				result = caseRequirement(g_RouteAssist);
			if (result == null)
				result = caseOclAny(g_RouteAssist);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.DDRIVER_KNOWS: {
			...
			if (result == null)
				result = caseDomainAssumption(d_DriverKnows);
			if (result == null)
				result = caseDefinableRequirement(d_DriverKnows);
			if (result == null)
				result = caseRequirement(d_DriverKnows);
			if (result == null)
				result = caseOclAny(d_DriverKnows);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TACAD_ASSISTS: {
			...
			if (result == null)
				result = caseTask(t_AcadAssists);
			if (result == null)
				result = casePerformativeRequirement(t_AcadAssists);
			if (result == null)
				result = caseDefinableRequirement(t_AcadAssists);
			if (result == null)
				result = caseRequirement(t_AcadAssists);
			if (result == null)
				result = caseOclAny(t_AcadAssists);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TSTAFF_ASSISTS: {
			...
			if (result == null)
				result = caseTask(t_StaffAssists);
			if (result == null)
				result = casePerformativeRequirement(t_StaffAssists);
			if (result == null)
				result = caseDefinableRequirement(t_StaffAssists);
			if (result == null)
				result = caseRequirement(t_StaffAssists);
			if (result == null)
				result = caseOclAny(t_StaffAssists);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TFEEDBACK: {
			...
			if (result == null)
				result = caseTask(t_Feedback);
			if (result == null)
				result = casePerformativeRequirement(t_Feedback);
			if (result == null)
				result = caseDefinableRequirement(t_Feedback);
			if (result == null)
				result = caseRequirement(t_Feedback);
			if (result == null)
				result = caseOclAny(t_Feedback);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.DGAZET_UPD: {
			...
			if (result == null)
				result = caseDomainAssumption(d_GazetUpd);
			if (result == null)
				result = caseDefinableRequirement(d_GazetUpd);
			if (result == null)
				result = caseRequirement(d_GazetUpd);
			if (result == null)
				result = caseOclAny(d_GazetUpd);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GMANUAL_MAP: {
			...
			if (result == null)
				result = caseGoal(g_ManualMap);
			if (result == null)
				result = casePerformativeRequirement(g_ManualMap);
			if (result == null)
				result = caseDefinableRequirement(g_ManualMap);
			if (result == null)
				result = caseRequirement(g_ManualMap);
			if (result == null)
				result = caseOclAny(g_ManualMap);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TCHECK_GAZET: {
			...
			if (result == null)
				result = caseTask(t_CheckGazet);
			if (result == null)
				result = casePerformativeRequirement(t_CheckGazet);
			if (result == null)
				result = caseDefinableRequirement(t_CheckGazet);
			if (result == null)
				result = caseRequirement(t_CheckGazet);
			if (result == null)
				result = caseOclAny(t_CheckGazet);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TCHECK_PAPER: {
			...
			if (result == null)
				result = caseTask(t_CheckPaper);
			if (result == null)
				result = casePerformativeRequirement(t_CheckPaper);
			if (result == null)
				result = caseDefinableRequirement(t_CheckPaper);
			if (result == null)
				result = caseRequirement(t_CheckPaper);
			if (result == null)
				result = caseOclAny(t_CheckPaper);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GDISP_EXCEPT: {
			...
			if (result == null)
				result = caseGoal(g_DispExcept);
			if (result == null)
				result = casePerformativeRequirement(g_DispExcept);
			if (result == null)
				result = caseDefinableRequirement(g_DispExcept);
			if (result == null)
				result = caseRequirement(g_DispExcept);
			if (result == null)
				result = caseOclAny(g_DispExcept);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GMONITOR_RES: {
			...
			if (result == null)
				result = caseGoal(g_MonitorRes);
			if (result == null)
				result = casePerformativeRequirement(g_MonitorRes);
			if (result == null)
				result = caseDefinableRequirement(g_MonitorRes);
			if (result == null)
				result = caseRequirement(g_MonitorRes);
			if (result == null)
				result = caseOclAny(g_MonitorRes);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.GUPD_POSITION: {
			...
			if (result == null)
				result = caseGoal(g_UpdPosition);
			if (result == null)
				result = casePerformativeRequirement(g_UpdPosition);
			if (result == null)
				result = caseDefinableRequirement(g_UpdPosition);
			if (result == null)
				result = caseRequirement(g_UpdPosition);
			if (result == null)
				result = caseOclAny(g_UpdPosition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.DMDT_POS: {
			...
			if (result == null)
				result = caseDomainAssumption(d_MDTPos);
			if (result == null)
				result = caseDefinableRequirement(d_MDTPos);
			if (result == null)
				result = caseRequirement(d_MDTPos);
			if (result == null)
				result = caseOclAny(d_MDTPos);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TRADIO_POS: {
			...
			if (result == null)
				result = caseTask(t_RadioPos);
			if (result == null)
				result = casePerformativeRequirement(t_RadioPos);
			if (result == null)
				result = caseDefinableRequirement(t_RadioPos);
			if (result == null)
				result = caseRequirement(t_RadioPos);
			if (result == null)
				result = caseOclAny(t_RadioPos);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.DMDT_USE: {
			...
			if (result == null)
				result = caseDomainAssumption(d_MDTUse);
			if (result == null)
				result = caseDefinableRequirement(d_MDTUse);
			if (result == null)
				result = caseRequirement(d_MDTUse);
			if (result == null)
				result = caseOclAny(d_MDTUse);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TMONITOR_STATUS: {
			...
			if (result == null)
				result = caseTask(t_MonitorStatus);
			if (result == null)
				result = casePerformativeRequirement(t_MonitorStatus);
			if (result == null)
				result = caseDefinableRequirement(t_MonitorStatus);
			if (result == null)
				result = caseRequirement(t_MonitorStatus);
			if (result == null)
				result = caseOclAny(t_MonitorStatus);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TDISP_STATUS: {
			...
			if (result == null)
				result = caseTask(t_DispStatus);
			if (result == null)
				result = casePerformativeRequirement(t_DispStatus);
			if (result == null)
				result = caseDefinableRequirement(t_DispStatus);
			if (result == null)
				result = caseRequirement(t_DispStatus);
			if (result == null)
				result = caseOclAny(t_DispStatus);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TDISP_DEP_ARRIV: {
			...
			if (result == null)
				result = caseTask(t_DispDepArriv);
			if (result == null)
				result = casePerformativeRequirement(t_DispDepArriv);
			if (result == null)
				result = caseDefinableRequirement(t_DispDepArriv);
			if (result == null)
				result = caseRequirement(t_DispDepArriv);
			if (result == null)
				result = caseOclAny(t_DispDepArriv);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TREPL_AMB: {
			...
			if (result == null)
				result = caseTask(t_ReplAmb);
			if (result == null)
				result = casePerformativeRequirement(t_ReplAmb);
			if (result == null)
				result = caseDefinableRequirement(t_ReplAmb);
			if (result == null)
				result = caseRequirement(t_ReplAmb);
			if (result == null)
				result = caseOclAny(t_ReplAmb);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TEXCEPT: {
			...
			if (result == null)
				result = caseTask(t_Except);
			if (result == null)
				result = casePerformativeRequirement(t_Except);
			if (result == null)
				result = caseDefinableRequirement(t_Except);
			if (result == null)
				result = caseRequirement(t_Except);
			if (result == null)
				result = caseOclAny(t_Except);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TEXCEPT_QUEUE: {
			...
			if (result == null)
				result = caseTask(t_ExceptQueue);
			if (result == null)
				result = casePerformativeRequirement(t_ExceptQueue);
			if (result == null)
				result = caseDefinableRequirement(t_ExceptQueue);
			if (result == null)
				result = caseRequirement(t_ExceptQueue);
			if (result == null)
				result = caseOclAny(t_ExceptQueue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.TCLOSE_INCIDENT: {
			...
			if (result == null)
				result = caseTask(t_CloseIncident);
			if (result == null)
				result = casePerformativeRequirement(t_CloseIncident);
			if (result == null)
				result = caseDefinableRequirement(t_CloseIncident);
			if (result == null)
				result = caseRequirement(t_CloseIncident);
			if (result == null)
				result = caseOclAny(t_CloseIncident);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.SFAST_DISPATCH: {
			...
			if (result == null)
				result = caseSoftgoal(s_FastDispatch);
			if (result == null)
				result = caseRequirement(s_FastDispatch);
			if (result == null)
				result = caseOclAny(s_FastDispatch);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.QDISPATCH: {
			...
			if (result == null)
				result = caseQualityConstraint(q_Dispatch);
			if (result == null)
				result = caseDefinableRequirement(q_Dispatch);
			if (result == null)
				result = caseRequirement(q_Dispatch);
			if (result == null)
				result = caseOclAny(q_Dispatch);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.SFAST_ASSIST: {
			...
			if (result == null)
				result = caseSoftgoal(s_FastAssist);
			if (result == null)
				result = caseRequirement(s_FastAssist);
			if (result == null)
				result = caseOclAny(s_FastAssist);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.QINCID_RESOLV: {
			...
			if (result == null)
				result = caseQualityConstraint(q_IncidResolv);
			if (result == null)
				result = caseDefinableRequirement(q_IncidResolv);
			if (result == null)
				result = caseRequirement(q_IncidResolv);
			if (result == null)
				result = caseOclAny(q_IncidResolv);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.SFAST_ARRIV: {
			...
			if (result == null)
				result = caseSoftgoal(s_FastArriv);
			if (result == null)
				result = caseRequirement(s_FastArriv);
			if (result == null)
				result = caseOclAny(s_FastArriv);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.QAMB_ARRIV: {
			...
			if (result == null)
				result = caseQualityConstraint(q_AmbArriv);
			if (result == null)
				result = caseDefinableRequirement(q_AmbArriv);
			if (result == null)
				result = caseRequirement(q_AmbArriv);
			if (result == null)
				result = caseOclAny(q_AmbArriv);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.SLOW_COST: {
			...
			if (result == null)
				result = caseSoftgoal(s_LowCost);
			if (result == null)
				result = caseRequirement(s_LowCost);
			if (result == null)
				result = caseOclAny(s_LowCost);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.QMAX_COST: {
			...
			if (result == null)
				result = caseQualityConstraint(q_MaxCost);
			if (result == null)
				result = caseDefinableRequirement(q_MaxCost);
			if (result == null)
				result = caseRequirement(q_MaxCost);
			if (result == null)
				result = caseOclAny(q_MaxCost);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.SUSER_FRIENDLY: {
			...
			if (result == null)
				result = caseSoftgoal(s_UserFriendly);
			if (result == null)
				result = caseRequirement(s_UserFriendly);
			if (result == null)
				result = caseOclAny(s_UserFriendly);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.QMAX_TIME_MSG: {
			...
			if (result == null)
				result = caseQualityConstraint(q_MaxTimeMsg);
			if (result == null)
				result = caseDefinableRequirement(q_MaxTimeMsg);
			if (result == null)
				result = caseRequirement(q_MaxTimeMsg);
			if (result == null)
				result = caseOclAny(q_MaxTimeMsg);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR1: {
			...
			if (result == null)
				result = caseEcaAwReq(ar1);
			if (result == null)
				result = caseAwReq(ar1);
			if (result == null)
				result = caseDefinableRequirement(ar1);
			if (result == null)
				result = caseRequirement(ar1);
			if (result == null)
				result = caseOclAny(ar1);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR2: {
			...
			if (result == null)
				result = caseEcaAwReq(ar2);
			if (result == null)
				result = caseAwReq(ar2);
			if (result == null)
				result = caseDefinableRequirement(ar2);
			if (result == null)
				result = caseRequirement(ar2);
			if (result == null)
				result = caseOclAny(ar2);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR3: {
			...
			if (result == null)
				result = caseEcaAwReq(ar3);
			if (result == null)
				result = caseAwReq(ar3);
			if (result == null)
				result = caseDefinableRequirement(ar3);
			if (result == null)
				result = caseRequirement(ar3);
			if (result == null)
				result = caseOclAny(ar3);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR4: {
			...
			if (result == null)
				result = caseEcaAwReq(ar4);
			if (result == null)
				result = caseAwReq(ar4);
			if (result == null)
				result = caseDefinableRequirement(ar4);
			if (result == null)
				result = caseRequirement(ar4);
			if (result == null)
				result = caseOclAny(ar4);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR5: {
			...
			if (result == null)
				result = caseEcaAwReq(ar5);
			if (result == null)
				result = caseAwReq(ar5);
			if (result == null)
				result = caseDefinableRequirement(ar5);
			if (result == null)
				result = caseRequirement(ar5);
			if (result == null)
				result = caseOclAny(ar5);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR6: {
			...
			if (result == null)
				result = caseEcaAwReq(ar6);
			if (result == null)
				result = caseAwReq(ar6);
			if (result == null)
				result = caseDefinableRequirement(ar6);
			if (result == null)
				result = caseRequirement(ar6);
			if (result == null)
				result = caseOclAny(ar6);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR7: {
			...
			if (result == null)
				result = caseEcaAwReq(ar7);
			if (result == null)
				result = caseAwReq(ar7);
			if (result == null)
				result = caseDefinableRequirement(ar7);
			if (result == null)
				result = caseRequirement(ar7);
			if (result == null)
				result = caseOclAny(ar7);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR8: {
			...
			if (result == null)
				result = caseEcaAwReq(ar8);
			if (result == null)
				result = caseAwReq(ar8);
			if (result == null)
				result = caseDefinableRequirement(ar8);
			if (result == null)
				result = caseRequirement(ar8);
			if (result == null)
				result = caseOclAny(ar8);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR9: {
			...
			if (result == null)
				result = caseEcaAwReq(ar9);
			if (result == null)
				result = caseAwReq(ar9);
			if (result == null)
				result = caseDefinableRequirement(ar9);
			if (result == null)
				result = caseRequirement(ar9);
			if (result == null)
				result = caseOclAny(ar9);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR10: {
			...
			if (result == null)
				result = caseEcaAwReq(ar10);
			if (result == null)
				result = caseAwReq(ar10);
			if (result == null)
				result = caseDefinableRequirement(ar10);
			if (result == null)
				result = caseRequirement(ar10);
			if (result == null)
				result = caseOclAny(ar10);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR11: {
			...
			if (result == null)
				result = caseEcaAwReq(ar11);
			if (result == null)
				result = caseAwReq(ar11);
			if (result == null)
				result = caseDefinableRequirement(ar11);
			if (result == null)
				result = caseRequirement(ar11);
			if (result == null)
				result = caseOclAny(ar11);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR12: {
			...
			if (result == null)
				result = caseEcaAwReq(ar12);
			if (result == null)
				result = caseAwReq(ar12);
			if (result == null)
				result = caseDefinableRequirement(ar12);
			if (result == null)
				result = caseRequirement(ar12);
			if (result == null)
				result = caseOclAny(ar12);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR13: {
			...
			if (result == null)
				result = caseEcaAwReq(ar13);
			if (result == null)
				result = caseAwReq(ar13);
			if (result == null)
				result = caseDefinableRequirement(ar13);
			if (result == null)
				result = caseRequirement(ar13);
			if (result == null)
				result = caseOclAny(ar13);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR14: {
			...
			if (result == null)
				result = caseEcaAwReq(ar14);
			if (result == null)
				result = caseAwReq(ar14);
			if (result == null)
				result = caseDefinableRequirement(ar14);
			if (result == null)
				result = caseRequirement(ar14);
			if (result == null)
				result = caseOclAny(ar14);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.AR15: {
			...
			if (result == null)
				result = caseEcaAwReq(ar15);
			if (result == null)
				result = caseAwReq(ar15);
			if (result == null)
				result = caseDefinableRequirement(ar15);
			if (result == null)
				result = caseRequirement(ar15);
			if (result == null)
				result = caseOclAny(ar15);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AcadPackage.ACAD_GOAL_MODEL: {
			...
			if (result == null)
				result = caseGoalModel(acadGoalModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GGen Dispatch</em>'. <!-- begin-user-doc -->
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GCall Taking</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DData Upd</em>'. <!-- begin-user-doc --> This
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GResource Id</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GResource Mob</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GObtain Map</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GIncident Upd</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DMax Calls</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GReg Call</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TConfirm Call</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GAssign Incident</em>'. <!-- begin-user-doc
	 * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TSearch Duplic</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TCreate Or Assign</em>'. <!-- begin-user-doc
	 * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TInput Info</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TDetect Loc</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TSpec Config</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TConf Incident</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TDet Best Amb</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TInform Stat</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GRoute Assist</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DDriver Knows</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TAcad Assists</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TStaff Assists</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TFeedback</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DGazet Upd</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GManual Map</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TCheck Gazet</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TCheck Paper</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GDisp Except</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GMonitor Res</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>GUpd Position</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DMDT Pos</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TRadio Pos</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DMDT Use</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TMonitor Status</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TDisp Status</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TDisp Dep Arriv</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TRepl Amb</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TExcept</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TExcept Queue</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TClose Incident</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>SFast Dispatch</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>QDispatch</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>SFast Assist</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>QIncid Resolv</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>SFast Arriv</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>QAmb Arriv</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>SLow Cost</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>QMax Cost</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>SUser Friendly</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>QMax Time Msg</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR1</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR2</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR3</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR4</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR5</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR6</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR7</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR8</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR9</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR10</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR11</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR12</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR13</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR14</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>AR15</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CV MST</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
